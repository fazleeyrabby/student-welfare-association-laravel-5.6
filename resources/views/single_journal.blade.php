            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="viewjournaldescriptiob">
                        <img class="img-responsive" src="../public/assets/backend_asset/blog_img/{{ $article->blog_img }}" width="100%" height="300px"> &nbsp;  &nbsp;  &nbsp;
                ...
                <div class="post-comments-wrap">
                  ...
                  <div class="col-md-4">
                    <div class="jurnalsidebar bg-light">
                        ...
                        <div class="fulltextpdf" style="padding: 10px;"><hr>
                        <h3>Full Text</h3>
                        <a href="../public/assets/backend_asset/filetoupload/{{ $article->filetoupload }}"><i class="fa fa-download" aria-hidden="true"></i></a>
                    </div><hr>
                    </div>
                </div>
            </div>
