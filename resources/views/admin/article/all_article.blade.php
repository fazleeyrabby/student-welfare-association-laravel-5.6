      ...
      <div class="title_right">
        <div class="col-md-5 col-sm-5 col-xs-12 form-group pull-right top_search">
          <div class="input-group">
            ...
            {!! Form::text('name','',array('class' => 'form-control', 'placeholder' => 'Search Blog title ')) !!}
                ...
                <tr>
                  ...
                  <td>
                    @if($article->publication_status=='1')
                      {!! "Published" !!}
                    @elseif($article->publication_status=='2')
                      {!! "Unpublished" !!}
                    @endif  
                  </td>
                  <td>

                    <a href="{!! route('article.show',$article->article_id) !!}" class="btn btn-sm bg-navy ">
                      <i class="fa fa-eye" aria-hidden="true"></i> Show
                    </a>
                    <a href="{!! route('article.edit',$article->article_id) !!}"class="btn btn-sm bg-orange ">
                      <i class="fa fa-pencil" aria-hidden="true"></i> Edit
                    </a>
                    <a href="./public/assets/backend_asset/filetoupload/{{ $article->filetoupload }}"><i class="fa fa-download" style="font-size:25px"></i></a>
