    ...
    <div class="x_content">
      ...
      {!! Form::open(['route' => 'article.store','files'=>true,'class'=>'form-horizontal']) !!}
        ...
        <div class="form-group">
          {!! Form::label('title', 'Blog title',array('class'=>'control-label col-md-3 col-sm-3 col-xs-12')) !!}
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('article_title','',array('class' => 'form-control col-md-7 col-xs-12', 'required' => 'required')) !!}
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="col-md-9 col-sm-9 col-xs-12">
            {!! Form::textarea('article_description',null,['class' => 'form-control summernote', 'required'=>'required']) !!}
          </div>
        </div>
         <div class="form-group">
          {!! Form::label('location','Author name',array('class'=>'control-label col-md-3 col-sm-3 col-xs-12')) !!}
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('author_name','',array('class'=>'form-control col-md-7 col-xs-12', 'required'=>'required')) !!}
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
          {!! Form::label('image','Attach File (Doc/pdf )',array('class'=>'control-label col-md-3 col-sm-3 col-xs-12')) !!}
          <div class="col-md-6 col-sm-6 col-xs-12">
           <!--  {!! Form::file('article_img',array('class'=>'form-control col-md-7 col-xs-12', 'required'=>'required')) !!} -->
