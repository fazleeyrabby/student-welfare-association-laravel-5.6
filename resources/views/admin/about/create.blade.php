...
<div class="col-md-8 col-md-offset-3">
  <div class="x_panel">
    <div class="x_title">
      <h2>Create new About or Overview info</h2>
    ...
    <div class="x_content">
      <br />
      {!! Form::open(['route' => 'about.store','class'=>'form-horizontal']) !!}
        <div class="form-group">
          {!! Form::label('bloodgroup','Text for
          ',array('class'=>'control-label col-md-3 col-sm-3 col-xs-12')) !!}
          <div class="col-md-6 col-sm-6 col-xs-12">
            <select class="form-control" name="text_type" required>
                    <option >Select Type of About / Overview</option>
