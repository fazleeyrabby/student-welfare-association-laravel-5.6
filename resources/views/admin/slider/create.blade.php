      ...
      {!! Form::open(['route' => 'slider.store','files'=>true,'class'=>'form-horizontal']) !!}
        <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('heading','',array('class' => 'form-control col-md-7 col-xs-12', 'required' => 'required')) !!}
          </div>
        </div>
        <div class="form-group">
          {!! Form::label('sub_heading','Slider Sub-Heading',array('class'=>'control-label col-md-3 col-sm-3 col-xs-12')) !!}
          <div class="col-md-6 col-sm-6 col-xs-12">
            {!! Form::text('sub_heading','',array('class'=>'form-control col-md-7 col-xs-12', 'required'=>'required')) !!}
          </div>
        </div>
        <div class="form-group">
